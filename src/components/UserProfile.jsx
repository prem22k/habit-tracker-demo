  ...
  if (isSetupComplete) {
    ...
    return (
      ...
      <motion.div
        ...
        className="min-h-screen bg-gradient-to-br from-black to-[#006D5B] text-white flex items-center justify-center"
      ...
      >
        ...
        <div className="bg-black bg-opacity-50 p-8 rounded-lg max-w-md w-full">
          ...
          <h2 className="text-2xl font-bold text-center text-white mb-6">Welcome, {profile.username}!</h2>
          ...
          <div className="flex justify-center mb-6">
            ...
            <CheckCircle className="w-16 h-16 text-[#5EEAD4]" />
          ...
          <p className="text-center text-white mb-6">Your profile has been saved successfully.</p>
          ...
          <Button 
            ...
            className="w-full bg-[#5EEAD4] text-black hover:bg-[#4ED8C0] flex items-center justify-center"
